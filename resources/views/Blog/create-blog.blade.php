...
{{-- <h2>Have Any Questions</h2> --}}
    ...
    <form action="/store-post" method="post" class="contact-form" enctype ="multipart/form-data"  >
        @csrf
        @error('title')
...
<div class="col-lg-12">
<div class="form-inner sibling2">
    <textarea class="" name="content" placeholder=" Post Content"></textarea>
...
POST NOW! &nbsp;<svg width="18" height="15" viewBox="0 0 22 13" xmlns="http://www.w3.org/2000/svg">
