...
<div class="contact-section dark3-bg pt-120 pb-120">
    ...
    <span>CONTACT US</span>
    <h2 class="text-white">Let us know your concern We Are Always Ready.</h2>
    </div>
    </div>
    </div>
    </div>
    ...
    {{-- <form > --}}
        ...
        <h3 style="color: white">{{session()->get('message')}}</h3>
       @endif
    ...
    <h2>Lets Talk</h2>
    <p>Join us in our mission to build a brighter future for the AAUA community. Justice, Equity, and Fairness are the values we uphold and deliver..</p>
    </div>
